...
local main_windows_state = imgui.ImBool(true) --------------------------ДАНЯ НЕ ЗАБУДЬ ПЕРЕКЛЮЧИТЬ В ФАЛС
...
function imgui.OnDrawFrame()
    ...
    if main_windows_state.v then
        ...
        if vkladki[4] == true then -- Настройки 
            ...
            imgui.NewLine() imgui.NewLine()
					imgui.SameLine(15) if imgui.Button(fa.ICON_FA_UPLOAD ..  u8'   Проверить обновления') then
